...
with open("analysis.txt", "a") as file:
    ...
    print("$\\mathit{\Summary statistics observations taken from my own work for the Principles of Data Analytic Module, with wording changed to match what was required for this project. Link: https://github.com/KaiiMenai/poda-tasks/blob/main/tasks.ipynb}$", file=file)
