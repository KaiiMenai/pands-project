...
with open("analysis.txt", "a") as file:
    ...
    selfref_text = "Summary statistics observations taken from my own work for the Principles of Data Analytic Module, with wording changed to match what was required for this project. Link: https://github.com/KaiiMenai/poda-tasks/blob/main/tasks.ipynb"
    italic_selfref_text = "\x1B[3m" + selfref_text + "\x1B[0m"
    print(italic_selfref_text, file=file)
